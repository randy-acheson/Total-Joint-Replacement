...
import edu.wpi.total_joint_replacement.GeneralInfoFragment;
...
public class RecordPainActivityTabbed extends AppCompatActivity implements ActionBar.TabListener, OnFragmentInteractionListener {
    ...
    StiffnessValueFragment stiffnessFragment = null;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                ...
                case 0:
                    ...
                    return painFragment;
                case 1:
                    if(stiffnessFragment == null){
                        stiffnessFragment = new StiffnessValueFragment();
                    }
                    return stiffnessFragment;
            }
        }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                ...
                case 1:
                    return getString(R.string.stiffness_tab_title).toUpperCase(l);
            }
            return null;
        }
    }
